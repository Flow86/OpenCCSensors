...
public class GuiSensor extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		mc.fontRenderer.drawString(sensorGuiName, this.xSize / 2 - (mc.fontRenderer.getStringWidth(sensorGuiName) / 2), 6, 4210752);
		mc.fontRenderer.drawString(StatCollector.translateToLocal("container.inventory"), 8, this.ySize - 96 + 2, 4210752);
	}
}
