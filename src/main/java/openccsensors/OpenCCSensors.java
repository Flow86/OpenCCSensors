...
@Mod(modid = "OCS", name = "OpenCCSensors", version = "@VERSION@-@BUILD_NUMBER@", dependencies = "required-after:ComputerCraft;after:CCTurtle;after:BuildCraft|Core;after:IC2;after:Thaumcraft;after:AppliedEnergistics;after:RailCraft;after:ArsMagica;after:UniversalElectricity;after:ThermalExpansion")
public class OpenCCSensors {
	...
	public static CreativeTabs tabOpenCCSensors = new CreativeTabs("tabOpenCCSensors") {
		...
		public Item getTabIconItem() {
			return Item.getItemFromBlock(Blocks.sensorBlock);
		}
	};
