...
public class BlockGauge extends BlockContainer {
	...
	public boolean canPlaceBlockOnSide(World world, int x, int y, int z, int side) {
		...
		return (dir == ForgeDirection.NORTH && (world.isSideSolid(x, y, z + 1, ForgeDirection.NORTH) || world.getTileEntity(x, y, z + 1) != null))
				|| (dir == ForgeDirection.SOUTH && (world.isSideSolid(x, y, z - 1, ForgeDirection.SOUTH) || world.getTileEntity(x, y, z - 1) != null))
				|| (dir == ForgeDirection.WEST && (world.isSideSolid(x + 1, y, z, ForgeDirection.WEST) || world.getTileEntity(x - 1, y, z) != null))
				|| (dir == ForgeDirection.EAST && (world.isSideSolid(x - 1, y, z, ForgeDirection.EAST) || world.getTileEntity(x - 1, y, z) != null));
	}
