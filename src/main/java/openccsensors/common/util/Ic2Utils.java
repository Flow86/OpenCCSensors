...
public class Ic2Utils {
	...
	public static boolean isValidPowerTarget(Object target) {
		return target != null
				&& (target instanceof IEnergySink || target instanceof IEnergySource || target instanceof IEnergyConductor || target instanceof IEnergyStorage);
	}
	...
	public static HashMap getPowerDetails(World world, Object obj, boolean additional) {
		...
		if (tile instanceof IEnergySink || tile instanceof IEnergySource || tile instanceof IEnergyConductor) {
