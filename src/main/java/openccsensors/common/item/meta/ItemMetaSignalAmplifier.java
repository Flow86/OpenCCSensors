...
public class ItemMetaSignalAmplifier implements IItemMeta, IRequiresIconLoading {
	...
	public ItemMetaSignalAmplifier(int id) {
		...
		CraftingManager
				.getInstance()
				.getRecipeList()
				.add(new ShapedOreRecipe(newItemStack(1), new Object[] { "sgs", "rrr", "sgs", Character.valueOf('s'), new ItemStack(Blocks.stone),
						Character.valueOf('r'), new ItemStack(Items.redstone), Character.valueOf('g'), new ItemStack(Items.gold_ingot), }));
	}
