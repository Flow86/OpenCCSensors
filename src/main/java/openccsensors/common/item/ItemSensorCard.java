...
public class ItemSensorCard extends Item implements ISensorCardRegistry {
	...
	public ItemSensorCard() {
		...
		GameRegistry.registerItem(this, "sensorCard");
	}
	...
	public void registerSensors() {
		...
		/*
		 * addSensorCard(9, new SensorCard(OpenCCSensors.Sensors.signSensor, tier1)); addSensorCard(10, new SensorCard(OpenCCSensors.Sensors.signSensor,
		 * tier2)); addSensorCard(11, new SensorCard(OpenCCSensors.Sensors.signSensor, tier3)); addSensorCard(12, new
		 * SensorCard(OpenCCSensors.Sensors.signSensor, tier4)); addIconsForLoading(OpenCCSensors.Sensors.signSensor);
		 */
	...
	public void addSensorCard(int id, SensorCard sensorCard) {
		...
		if (sensorCard.getTier() == OpenCCSensors.Tiers.tier1) {
			RecipeUtils.addTier1Recipe(sensorCard.getSensor().getUniqueRecipeItem(), new ItemStack(OpenCCSensors.Items.sensorCard, 1, id));
			...
			RecipeUtils.addTier2Recipe(new ItemStack(OpenCCSensors.Items.sensorCard, 1, previousTier.getKey()), new ItemStack(OpenCCSensors.Items.sensorCard,
					1, id));
			...
			RecipeUtils.addTier3Recipe(new ItemStack(OpenCCSensors.Items.sensorCard, 1, previousTier.getKey()), new ItemStack(OpenCCSensors.Items.sensorCard,
					1, id));
			...
			RecipeUtils.addTier4Recipe(new ItemStack(OpenCCSensors.Items.sensorCard, 1, previousTier.getKey()), new ItemStack(OpenCCSensors.Items.sensorCard,
					1, id));
		}
	}
